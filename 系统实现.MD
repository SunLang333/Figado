...
在 `SunLang333/Figado` 项目中，前端使用 Capacitor 打包到 Android Studio 的相关信息如下：

### 5.6.1 Capacitor 配置文件

**文件路径**: [bookapp_vuetify/capacitor.config.json](https://github.com/SunLang333/Figado/blob/9ebc885735f72a6c0fb4ef24ac508c9f66bec01b/bookapp_vuetify/capacitor.config.json)

```json
{
  "appId": "com.Figaro.app",
  "appName": "Figaro",
  "webDir": "dist",
  "server": {
    "androidScheme": "https"
...
这个文件定义了应用的基本配置，包括应用 ID、名称、构建目录和 Android Scheme。

---

### 5.6.2 构建脚本

**文件路径**: [bookapp_vuetify/package.json](https://github.com/SunLang333/Figado/blob/9ebc885735f72a6c0fb4ef24ac508c9f66bec01b/bookapp_vuetify/package.json)
...
- `cap:sync`: 同步 Capacitor 配置到 Android 项目。
- `cap:build`: 构建项目并同步到 Capacitor。
- `cap:open:android`: 打开 Android Studio。
- `cap:run:android`: 在 Android 模拟器或设备上运行应用。

---

### 5.6.3 Android Studio 项目文件

#### (1) **Capacitor Gradle 设置**

**文件路径**: [bookapp_vuetify/android/capacitor.settings.gradle](https://github.com/SunLang333/Figado/blob/9ebc885735f72a6c0fb4ef24ac508c9f66bec01b/bookapp_vuetify/android/capacitor.settings.gradle)
...
说明：自动生成的文件，管理 Capacitor 的模块依赖。

#### (2) **Gradle 构建文件**

**文件路径**: [bookapp_vuetify/android/app/capacitor.build.gradle](https://github.com/SunLang333/Figado/blob/9ebc885735f72a6c0fb4ef24ac508c9f66bec01b/bookapp_vuetify/android/app/capacitor.build.gradle)
...
说明：定义了 Java 版本兼容性及 Capacitor 插件依赖。

#### (3) **AndroidManifest.xml**

**文件路径**: [bookapp_vuetify/android/app/src/main/AndroidManifest.xml](https://github.com/SunLang333/Figado/blob/9ebc885735f72a6c0fb4ef24ac508c9f66bec01b/bookapp_vuetify/android/app/src/main/AndroidManifest.xml)
...
4. **打开 Android Studio**:
   ...
   ```
5. 在 Android Studio 中运行或调试应用。

如果有其他问题或者需要进一步帮助，请告诉我！
